...
export class DropboxService {
    ...
    constructor(private readonly config: ConfigService) {
        ...
        if (!this.ACCESS_TOKEN || !this.AUTH_CODE || !this.APP_KEY || !this.APP_SECRET || !this.REDIRECT_URI || !this.REFRESH_TOKEN) {
            throw new Error("Dropbox access token, app key, app secret or auth code not set")
        }
    }
